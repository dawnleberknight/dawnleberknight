          ...
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center">
              ...
              <p className="mb-4">
                ...
                Educational Technology at University of South Carolina. This
                website is my professional portfolio to highlight my learning
                adventure throughout the past two years.
              </p>
            </div>
          </div>
        </div>
