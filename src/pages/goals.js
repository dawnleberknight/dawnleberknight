        ...
        <section className="page-section" id="services">
          <div className="container">
            <p>
              ...
              my educational endeavors. This led me to a career as an educator
              and to the development of my personal belief that learning is the
              ongoing, life-long process of gaining and applying new knowledge
              and skills. As an instructional designer, I seek to better
              understand factors which influence student engagement and
              performance, especially in the online learning environment, in
              order to identify design strategies for educational opportunities
              which meet the diverse needs of the learners.
            </p>
            <p>
              ...
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  ...
                  <p className="text-muted mb-0">
                    ...
                    become leaders in interprofessional, transformative
                    practice.
                  </p>
                </div>
              </div>
            ...
            <div className="pt-5">
              <p>
                <span>
                  To learn more about my professional experience, please review
                  my{' '}
                </span>
                <a
