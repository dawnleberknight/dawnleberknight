      ...
      <section className="page-section" id="services">
        <div className="container">
          <p className="mb-4">
            ...
            education, recruitment, and retention programs to build and support
            the healthcare workforce in the state. In this role, I primarily
            focus on developing distance education programs and online courses
            for future and current healthcare professionals, and I really
            enjoying being able to work with subject matter experts throughout
            the state in order to create educational opportunities which meet
          ...
          <p className="mb-4">
            ...
            software engineer. We have a two daughters, 9 year old Brooklyn and
