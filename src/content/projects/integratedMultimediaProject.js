...
export default {
  ...
  performanceIndicator: [
    ...
    },
    {
      ...
      implementation: `We selected and used ${GoogleSitesLink} (website), ${CanvaLink} (cover art, marketing poster), ${CitrixWebExLink} (recording tool), and ${IMovieLink} (vodcast/podcast production).`,
    },
    {
