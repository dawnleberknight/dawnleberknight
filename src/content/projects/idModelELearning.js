export default {
  ...
  contextAndConditions:
    'During the Spring 2021 Advanced Instructional Design and Development (EDET 793) course with Dr. Michael Grant, we explored additional instructional design models in order to become more expert in at least one other model. I selected the Dick and Carey model of instructional design and used a new development tool to create an eLearning module.',
  scope:
    'Following the MRK instructional design process, I designed and developed an eLearning product using a rapid eLearning development tool which was new to me, Udutu. The 30-minute eLearning module was developed to educate graduate-level, novice instructional design students on the Dick and Carey model of instructional design.',
  role:
  ...
  performanceIndicator: [
    ...
    },
    {
      ...
      implementation:
        'I explored and learned more about the Dick and Carey model, Mayer’s multimedia learning principles, and a new rapid eLearning development tool (Udutu) in order to further progress in my role as an instructional designer.',
    },
    {
  ...
  reflection: `Since this was one of the final projects in the M.Ed. program, I had advanced experience with following the MRK instructional design process to develop an eLearning product, and this artifact demonstrates more advanced application of knowledge and skills. However, Udutu was a rapid eLearning development tool which I had not yet used, and I enjoyed learning and gaining experience with this program. In addition, I learned about Mayer's multimedia learning principles and applied those concepts when designing and developing the eLearning module.`,
}
